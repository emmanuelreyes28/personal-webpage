    ...
    <div>
      ...
      <div className="font-display text-center leading-relaxed tracking-wide w-1/2 pt-6 mx-auto">
        ...
        <p className="pb-2">
          ...
          party logins amongst a variety of topics and technologies. My career
          goal is to become a Full Stack Engineer, and I am always seeking
          opportunities for growth and development. I strive to be part of a
          company that supports and challenges me in this pursuit, and I am
